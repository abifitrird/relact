        ...
        if ($this->uri->segment(4) !== 'check') {
            if ($this->uri->segment(1)) {
                ...
                if ($this->uri->segment(2) && $this->uri->segment(3)) {
                    ...
                    if ($this->uri->segment(6) == 'sub' && $this->uri->segment(7)) {
                        $sub_id = $this->uri->segment(7);
                    }
                }

                $this->Log->saveLog($data, $kode_kelas, $kode_materi, $sub_id, $is_soal);
            }
        }
    }
