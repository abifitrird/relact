  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="<?php echo base_url("Teacher/Guru/profil") ?>" class="list-group-item list-group-item-action mb-2">
          <svg style="width:24px;height:24px" viewBox="0 0 24 24">
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg border-bottom shadow-sm">
        ...
        <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
          <li>
            <a href="#"><button type="button" class="btn btn-secondary mr-1">
                Tambah Materi
              </button></a>
          </li>
      ...
      <div class="container-fluid shadow-sm" style="padding: 25px">
        ...
        <div class="list-group">
          <a href="<?php echo base_url('Teacher/Kelas/lihatMateri') ?>" class="list-group-item list-group-item-action">
          ...
          <a href="<?php echo base_url('Teacher/Kelas/lihatSoal') ?>" class="list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-between">
