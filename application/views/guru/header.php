    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo site_url("guru/profil") ?>" class="list-group-item list-group-item-action mb-2">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <a href="<?php echo site_url("guru/kelas") ?>" class="list-group-item list-group-item-action mb-2">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <a href="<?php echo site_url("guru/capaian") ?>" class="list-group-item list-group-item-action mb-2">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
