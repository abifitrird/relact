...
<div class="container-fluid">
    ...
    <div class="row shadow-sm" style="padding: 25px">
        <div class="col-2">
            <img src="<?php echo base_url(isset($data['url_foto']) ? 'uploads/profil/' . $data['url_foto'] : 'assets/images/student.png') ?>" class="shadow-sm rounded-circle" style=" width: 150px; height: 150px;">
        </div>
