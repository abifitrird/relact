...
<div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="<?php echo base_url("Student/Siswa") ?>" class="list-group-item list-group-item-action mb-2">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            <path fill="currentColor" d="M12,3L20,9V21H15V14H9V21H4V9L12,3Z" /></svg>
            Beranda
        </a>
        <a href="<?php echo base_url("Student/Siswa/profil") ?>" class="list-group-item list-group-item-action mb-2">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <a href="<?php echo base_url("Student/Kelas") ?>" class="list-group-item list-group-item-action mb-2">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
        ...
        <a href="<?php echo base_url("Student/Kelas/lihatCapaian") ?>" class="list-group-item list-group-item-action mb-2">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <div class="px-1 mb-2 col-3">
                    <div class="bg-white rounded shadow-sm d-flex flex-wrap">
                        <div class="px-2 pt-3 col-12 rounded-top text-white bg-dark">
                            <a href="<?php echo base_url('Student/Kelas/listMateri')?>" class="text-white">
